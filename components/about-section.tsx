    ...
    <section id="about" className="w-full py-12 md:py-24 lg:py-32 bg-neutral-50">
      <div className="container px-4 md:px-6">
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center mb-16">
          <AnimatedSection direction="right" delay={200} className="space-y-4">
          ...
          <AnimatedSection
            direction="left"
            delay={300}
            className="relative h-[300px] md:h-[400px] overflow-hidden rounded-xl bg-gray-100"
          >
            <img
        ...
        <div className="space-y-8">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            {/* Founder 2 */}
            <AnimatedSection direction="up" delay={400} className="flex flex-col items-center space-y-4">
            ...
            {/* Founder 3 */}
            <AnimatedSection direction="up" delay={500} className="flex flex-col items-center space-y-4">
              <div className="relative h-36 w-36 md:h-48 md:w-48 overflow-hidden rounded-full">
                <img
                  src="/placeholder.svg?height=400&width=400"
