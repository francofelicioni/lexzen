      ...
      <AnimatedSection direction="up" elementType="heading">
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center mb-16">
          <div className="space-y-4 text-justify">
            ...
            <p className="text-gray-500 p-4 rounded">{t("about.storyContent1")}</p>
            <p className="text-gray-500 p-4 rounded">{t("about.storyContent2")}</p>
            <p className="text-gray-500 p-4 rounded">{t("about.storyContent3")}</p>
            <p className="text-gray-500 p-4 rounded">{t("about.storyContent4")}</p>
            <p className="text-gray-500 p-4 rounded">{t("about.storyContent5")}</p>
            <p className="text-gray-500 p-4 rounded">{t("about.storyContent6")}</p>
          </div>
